        ...
        Row(
                ...
                children: [
                  Container(
                    ...
                    child: ClipOval(
                      child: CustomAssetImage(path: AppImages.demo,fit: BoxFit.cover,),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Annette Johnson",style: AppTextStyles.subTitleMedium(),),
                        const MarginWidget(factor: 0.3),
                        Text("Data da aula: 15-06-2023",style: AppTextStyles.subTitleRegular(),),
                        const MarginWidget(factor: 0.3),
                        Text("Horário: 10h00",style: AppTextStyles.subTitleRegular(),),
                        const MarginWidget(factor: 0.3),
                        Text("Hoje tivemos uma grande evolução na aula.",style: AppTextStyles.subTitleRegular(color: CColors.textFieldBorder),),
                        const MarginWidget(factor: 0.5),
                        Text("Percepção sobre o progresso",style: AppTextStyles.subTitleRegular(),),
                        const MarginWidget(factor: 0.3),
                        rating(),
                      ],
                    ),
