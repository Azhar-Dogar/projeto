...
class CreditCardFormWidget extends StatefulWidget {
  const CreditCardFormWidget({
    ...
    this.expiryDateKey,
    this.cvvCodeKey,
    this.cvvValidationMessage = 'Por favor insira o CVV',
    this.dateValidationMessage = 'Por favor, insira a validade do cartão primeiro',
    this.numberValidationMessage = 'Por favor, insira o número do cartão primeiro',
    this.nameValidationMessage = 'Por favor, insira primeiro o nome do titular do cartão',
  ...
  /// Error message string when invalid name is entered.
